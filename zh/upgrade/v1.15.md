...
### 12. 如果正在使用 Request.Input* 方法

需相应修改：[优化 Request.Input* 方法](#优化-request-input-方法)

### 13. 如果正在使用 validation.PrepareForValidation 方法
