...
- [Migration 支持使用 Go 语言迁移](#migration-支持-go-语言迁移)
...
- [Route 废弃 Shutdown 方法](#route-废弃-shutdown-方法)
...
4. 修改 `app/providers/database_service_provider.go` 文件完成注册：
...
### Route 废弃 Shutdown 方法

Version: v1.15.0

`Shutdown` 方法已废弃，请使用 `Stop` 方法代替。
