...
- [支持直接设置 DSN 连接数据库](#支持直接设置-dsn-连接数据库)<<<<<<< HEAD
- [Orm 新增配置项](#orm-新增配置项)
...
### 14. 如果正在使用 Request.Input* 方法

需相应修改：[优化 Request.Input* 方法](#优化-request-input-方法)

### 15. 如果正在使用 validation.PrepareForValidation 方法
...
"postgresql": map[string]any{
  ...
  ...
++ "schema": "goravel",// Set the default schema for the connection
