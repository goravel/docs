...
- [facades.Queue() 支持自定义驱动](#facades-queue-支持自定义驱动)
...
### facades.Queue() 支持自定义驱动

v1.15 之前 Queue 仅支持同步驱动与 Redis 驱动，从 v1.16 开始支持数据库驱动及自定义驱动，详情请 [查看文档](../digging-deeper/queues.md#驱动)。
