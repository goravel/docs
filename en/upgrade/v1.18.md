...
### 4. Rename grpc.servers config key to grpc.clients
...
> **Note**: Middleware comparison uses reflection to match middleware types. Closure-based middleware (inline `func(ctx http.Context)`) share a single type and cannot be individually excluded. Use struct-based middleware for reliable exclusion.
