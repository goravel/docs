...
hero:
  ...
  tagline: 模块化、高性能、易扩展，PHPers 的首选。
  # image: /logo.svg
  actions:
    - theme: brand
      text: 快速开始
...
<div class="text-sm" :class="$style.group_text">微信入群，请备注 Goravel</div>
</div>
...
</a><div class="text-sm" :class="$style.group_text">点击我加入 Discord</div>
</div>
...
<div class="flex flex-col items-center">
<div class="text-center mt-10 text-3xl font-bold">打赏</div>
<div class="mt-10 flex">

<div class="text-center mr-10">
<img src="/reward-wechat.jpg" width="200">
<div class="text-sm" :class="$style.group_text">微信扫码</div>
</div>
