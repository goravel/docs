...
| [goravel/goravel-lite](https://github.com/goravel/goravel-lite)       | 轻量版 Goravel                                                                                                                                 |
...
| [goravel/installer](https://github.com/goravel/installer)             | 安装 Goravel 框架的命令行工具                                                                                                                         |
...
Goravel 为 AI 编码助手（Claude Code、OpenCode 等）提供代理技能 以帮助贡献者遵循 Goravel 开发规范，如测试、命名和拉取请求工作流程。 技能来源于 [goravel/agents](https://github.com/goravel/agents) 仓库。

首先，如果尚未安装，请安装 `goravel` CLI：
...
默认将所有 Goravel 代理技能安装到 `~/.agents/skills`：
