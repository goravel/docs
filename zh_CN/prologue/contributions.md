...
Goravel 为 AI 编码助手（Claude Code、OpenCode 等）提供了 Agent 技能，帮助贡献者遵循 Goravel 开发规范，例如测试、命名和 Pull Request 工作流。技能源自 [goravel/agents](https://github.com/goravel/agents) 仓库。
...
默认将所有 Goravel Agent 技能安装到 `~/.agents/skills`：
