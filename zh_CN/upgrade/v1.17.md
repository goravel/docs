...
邮件发送支持模板，允许你使用预定义的模板发送电子邮件，以获得更好的一致性和更轻松的管理。 The template supports http/template and custom drivers.
