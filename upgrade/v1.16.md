...
- [Orm supports setting Global Scope](#orm-supports-setting-global-scope)
- [Different JWT Guard supports different configurations](#different-jwt-guard-supports-different-configurations)
- [Add route:list command](#add-route-list-command)
...
- [Optimize Testing.Request method](#optimize-testing-request-method)
...
### 11. If Using Testing.Request method
...
### Orm supports setting Global Scope
...
### Optimize Testing.Request method
