...
```shell
go get github.com/goravel/framework@v1.16.0

// If using gin
go get github.com/goravel/gin@v1.4.0

// If using fiber
go get github.com/goravel/fiber@v1.4.0

// If using redis
go get github.com/goravel/redis@v1.4.0

// If using S3
go get github.com/goravel/s3@v1.4.0

// If using Oss
go get github.com/goravel/oss@v1.4.0

// If using Cos
go get github.com/goravel/cos@v1.4.0

// If using Minio
go get github.com/goravel/minio@v1.4.0

// If using Cloudinary
go get github.com/goravel/cloudinary@v1.4.0
...
4. Add `queue:failed` command, used to view failed tasks.
5. Support setting the number of retries when starting the queue task.
