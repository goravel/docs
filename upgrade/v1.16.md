...
- [facades.Queue() supports custom driver](#facades-queue-supports-custom-driver)
...
### facades.Queue() supports custom driver

Before v1.15, Queue only supported sync and Redis drivers, starting from v1.16, it supports database and custom driver, please [view document](../digging-deeper/queues.md#driver).

[View Document](../digging-deeper/queues.md#driver)
