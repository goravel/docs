...
- [Remove The Global HTTP Middleware Loaded By Default](#remove-the-global-http-middleware-loaded-by-default)
- [Optimize Remember And RememberForever Methods In facades.Cache()](#6-optimize-remember-and-rememberforever-methods-in-facades-cache-optional)
- [Remove Deprecated Methods](#7-remove-deprecated-methods)
