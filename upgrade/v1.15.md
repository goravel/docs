...
// If using S3
go get -u github.com/goravel/s3@v1.3.0

// If using Oss
go get -u github.com/goravel/oss@v1.3.0

// If using Cos
go get -u github.com/goravel/cos@v1.3.0

// If using Minio
go get -u github.com/goravel/minio@v1.3.0
...
### 9. If you are using the Clear method of Testing.Database
...
### 12. If you are using the Request.Input* method

Need to modify accordingly: [Optimize the Request.Input* method](#optimize-the-requestinput-method)

### 13. If you are using the validation.PrepareForValidation method
...
### 14. If you are using the Mail module
