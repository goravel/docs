...
- [Add Carbon Module](#add-helpers-method)
...
- [Modify The Calling Type Of Facades(1.12.0)](#3--modify-facades-*)
...
- [Change The Type Of CreatedAt, UpdatedAt In Model](#9--change-the-type-of-createdat--updatedat-in-model)
- [Optimize The Rule Of Validation Module](#10--optimize-the-rule-of-validation-module)
