...
- [Add Path Helpers Methods](#add-path-helpers-method)
...
### Add Path Helpers Methods

Version: v1.12.0

Through the Path Helpers methods, you can easily get the path information in project, [For Detail](../digging-deeper/helpers.md#paths)。
