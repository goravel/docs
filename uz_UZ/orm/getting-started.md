...
Global skop ichida `facades.Orm().WithContext(ctx)` orqali uzatilgan kontekstga so'rovdan kirishingiz mumkin:
...
| Context                     | [Kontekstni kiritish](#kontekstni-kiritish)                                                                 |
