...
- [Validatsiya modulini qo'shish(v1.7.0)](#bog-liqliklarni-yangilash)
- [So'rov shablonidagi XATOni tuzatish(v1.7.1)](#validatsiya-modulini-qo-shish)
- [Validatsiya modulidagi XATOni tuzatish(v1.7.2)](#so-rov-shablonidagi-xatoni-tuzatish)
- [Auth modulidagi XATOni tuzatish(v1.7.3)](#validatsiya-modulidagi-xatoni-tuzatish)

## Past ta'sirli o'zgarishlar

- [Navbat modulining navbat nomini optimallashtirish(v1.7.2)](#navbat-modulining-navbat-nomini-optimallashtirish)
