...
- [JWT muammosini tuzatish](#jwt-muammosini-tuzatish)

## v1.12.5

### Xatolarni tuzatish 🐛

- [facades.Orm().Query().Load() muammosini tuzatish](#facades-orm-query-load-muammosini-tuzatish)

## v1.12.4

### Xatolarni tuzatish 🐛

- [Throttle middleware'ining panic otishi muammosi](#throttle-middleware-ning-panika-otishi-muammosi)

## v1.12.3

### Xatolarni tuzatish 🐛

- [Windows ostida make:package buyrug'i muammosi](#windows-ostida-make-package-buyrug-i-muammosi)

## v1.12.2

### Xatolarni tuzatish 🐛

- [facades.Gate() ning nil qaytarishi muammosi](#facades-gate-ning-nil-qaytarishi-muammosi)

## v1.12.1

### Xatolarni tuzatish 🐛

- [Windows ostida fayl yo'li sabab bo'lgan panic muammosi](#windows-ostida-fayl-yo-li-sabab-bo-lgan-panika-muammosi)

## v1.12.0

### Hayajonli yangi xususiyatlar 🎉

- [Service Container(1.12.0)](#xizmat-konteyneri)
- [Paketni Ishlab Chiqish(1.12.0)](#paketlarni-ishlab-chiqish)
- [Carbon modulini qo'shish](#yordamchi-metodlar-qo-shish)

## Yaxshilanishlar 🚀

- [Artisan flag'iga yangi metodlar qo'shildi](#artisan-flag-yangi-metodlar-qo-shadi)
- [Yordamchi metodlar qo'shildi](#yordamchi-metodlar-qo-shish)
- [Bog'liqliklarni yangilash](#bog-liqliklarni-yangilash)
- [Migration'ga yangi metodlar qo'shildi](#migratsiya-yangi-metodlar-qo-shadi)
- [Ba'zi `make` buyruqlari kichik kataloglarni qo'llab-quvvatlaydi](#ba-zi-make-buyruqlari-pastki-kataloglarni-qo-llab-quvvatlaydi)

## O'zgartirishlar 🛠

- [Facades chaqiruv turini o'zgartirish(1.12.0)](#3-facades-ni-o-zgartirish)
- [Artisan Flag'ni optimallashtirish(1.12.0)](#6-artisan-buyrug-idagi-flagni-o-zgartirish-agar-ishlatilsa)
- [Filesystem moduli S3, OSS, COS, Minio uchun standart qo'llab-quvvatlashni bekor qiladi](#7-fayl-tizimi-moduli-s3-oss-cos-minio-uchun-standart-qo-llab-quvvatlashni-bekor-qiladi)
- [Cache moduli Redis uchun standart qo'llab-quvvatlashni bekor qiladi](#8-kesh-moduli-redis-uchun-standart-qo-llab-quvvatlashni-bekor-qiladi)
- [Modeldagi CreatedAt, UpdatedAt turlarini o'zgartirish](#9-modeldagi-createdat-updatedat-maydonlarining-turini-o-zgartirish-agar-ishlatilsa)
- [Validation moduli qoidasini optimallashtirish](#10-tekshirish-moduli-qoidasini-optimallashtirish-agar-ishlatilsa)
