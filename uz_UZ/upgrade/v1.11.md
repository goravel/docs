...
- [Schedule'dagi panic tufayli jarayon to'xtatilishi muammosi](#schedule-da-panika-sababli-jarayon-to-xtashi-muammosi)
- [Schedule'dagi DailyAt har daqiqa bajarilishi muammosi](#schedule-dagi-dailyat-har-minut-bajarilishi-muammosi)

## v1.11.2

### Xatolik tuzatishlar 🐛

- [Request.Input() va Request.Bind() ni bir vaqtda ishlatishda ma'lumot xatosi tuzatildi](#request-input-va-request-bind-ni-bir-vaqtda-ishlatishda-ma-lumot-xatosini-tuzatish)-and-request-bind\(\)-at-the-same-time)

## v1.11.1

### Qiziqarli yangi xususiyatlar 🎉

- [Route resurs marshrutlash qo'shdi](#marshrut-resurs-marshrutlash-qo-shish)
- [Request yangi usullar qo'shdi](#orm-yangi-usullar-qo-shdi)
- [Storage yangi usullar qo'shdi](#orm-yangi-usullar-qo-shdi)
- [File yangi usullar qo'shdi](#fayl-yangi-usullarni-qo-shadi)

### Xatolik tuzatishlar 🐛

- [Filesystem uchun noto'g'ri Windows yo'li xatosi tuzatildi](#fayl-tizimi-uchun-noto-g-ri-windows-yo-li-xatosini-tuzatish)
- [Request uchun Header usulining panic xatosi tuzatildi](#so-rov-uchun-header-usuli-panikasini-tuzatish)

## v1.11.0

## Qiziqarli yangi xususiyatlar 🎉

- [Orm model voqealari qo'shdi (1.11.0)](#orm-model-voqealari-qo-shdi)

## Takomillashtirishlar 🚀

- [Cache usullar qo'shdi va optimallashtirdi (1.11.0)](#cache-usullar-qo-shdi-va-optimallashtirdi)
- [Route Fallback marshrutini qo'llab-quvvatlaydi (1.11.0)](#route-fallback-marshrutini-qo-llab-quvvatlaydi)
- [Orm yangi usullar qo'shdi (1.11.0)](#orm-yangi-usullar-qo-shdi)
- [facades.Config.Add() optimallashtirildi (1.11.0)](#facades-config-add-optimallashtirildi)
- [Sqlite haydovchi o'zgartirildi (1.11.0)](#sqlite-haydovchi-o-zgartirildi)
- [contracts/http net/http usul xaritalashini qo'shdi (1.11.0)](#contracts-http-net-http-usul-xaritalashini-qo-shdi)

### O'zgarishlar 🛠

- [Orm usullarni olib tashladi (1.11.0)](#2-eskirgan-usullarni-olib-tashlash)
