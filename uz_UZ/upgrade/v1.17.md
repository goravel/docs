...
- [ServiceProvider.Boot() da ro'yxatdan o'tgan marshrutlar WithMiddleware() ishlatilganda jimgina tashlab yuborilishini tuzatish](#fix-routes-registered-in-serviceproviderboot-silently-discarded-when-withmiddleware-is-used)
...
- [LOG_LEVEL ga rioya qilinmasligini tuzatish](#fix-log_level-not-being-respected)
