...
- [Soddalashtirilgan kod tuzilmasi](#soddalashtirilgan-kod-tuzilmasi)
- [Jarayon Fasad](#jarayon-fasad)
- [Pluralizer Paketi](#pluralizer-paketi)
- [Xizmat ko'rsatuvchi ishga tushiruvchilar](#xizmat-ko-rsatuvchi-ishga-tushiruvchilar)

## Yaxshilanishlar 🚀

- [facades kerak bo'lganda o'rnatilishi va o'chirilishi mumkin](#fasadlar-kerak-bo-lganda-o-rnatilishi-va-o-chirilishi-mumkin)
- [Pochta andozalar orqali yuborilishi mumkin](#pochta-shablon-orqali-yuborilishi-mumkin)
- [build buyrug'i ko'proq bayroqlarni qo'llab-quvvatlaydi](#build-buyrug-i-ko-proq-bayroqlarni-qo-llab-quvvatlaydi)
- [DB va Orm uchun funksiyalar qo'shish va o'zgartirish](#db-va-orm-uchun-funksiyalar-qo-shildi-va-o-zgartirildi)
- [Schema uchun yangi funksiyalar qo'shish](#schema-uchun-yangi-funksiyalar-qo-shildi)
- [Yangi buyruqlar qo'shish](#yangi-buyruqlar-qo-shildi)
- [CSRF token middleware qo‘shish](#csrf-token-middleware-qo-shish)
- [Buyruq Argumentlarni sozlashni qo'llab-quvvatlaydi](#buyruq-argumentlarni-sozlashni-qo-llab-quvvatlaydi)
- [make:migration model orqali migratsiya yaratishni qo'llab-quvvatlaydi](#make-migration-model-orqali-migratsiya-yaratishni-qo-llab-quvvatlaydi)
- [gRPC mijoz ulanishlarini optimallashtirish](#grpc-klient-ulanishlari-optimallashtirildi)
- [Log json formatda chop etishni qo'llab-quvvatlaydi](#log-json-formatda-chop-etishni-qo-llab-quvvatlaydi)
- [Http bir nechta mijozlarni qo'llab-quvvatlaydi](#http-bir-nechta-klientlarni-qo-llab-quvvatlaydi)
- [Validation kontekstni uzatishni qo'llab-quvvatlaydi](#validatsiya-kontekstni-uzatishni-qo-llab-quvvatlaydi)
- [Orm uchun WithoutGlobalScopes funksiyasini qo'shish](#orm-uchun-withoutglobalscopes-funksiyasi-qo-shildi)

## O'zgarishlar 🛠

- [machinery navbat haydovchisi olib tashlandi](#machinery-navbat-haydovchisi-olib-tashlandi)
- [gRPC konfiguratsiyasini o‘zgartirish](#grpc-konfiguratsiyasini-o-zgartirish)
- [Log haydovchisi almashtirildi](#log-drayverini-almashtirish)
- [migrate:rollback buyrug'ini optimallashtirish](#migrate-rollback-buyrug-ini-optimallashtirish)
- [Http.Request.Bind funksiyasi olib tashlandi](#http-request-bind-funksiyasini-olib-tashlash)
- [Paket sozlash metodini o‘zgartirish](#paket-sozlash-metodini-o-zgartirish)

## v1.17.1

- [Statik bayroq bilan build buyrug‘i xatosini tuzatish](#statik-bayroq-bilan-build-buyrug-i-xatosini-tuzatish)
- [Ba‘zi make buyruqlari eski kod tuzilmasiga mos kelmasligini tuzatish](#ba-zi-make-buyruqlari-eski-kod-tuzilmasiga-mos-kelmasligini-tuzatish)
- [Eski versiya loyihasida paket o‘rnatishda sozlamani optimallashtirish](#eski-versiya-loyihasida-paket-o-rnatishda-sozlamani-optimallashtirish)
- [Navbat konkurentligi 1 dan katta bo‘lganda kechiktirilgan vazifa muammosini tuzatish](#navbat-konkurentligi-1-dan-katta-bo-lganda-kechiktirilgan-vazifa-muammosini-tuzatish)

## v1.17.2

- [Migrate:rollback buyrug‘ini tuzatish](#migrate-rollback-buyrug-ini-tuzatish)

## v1.17.3

- [Schema ulanish drayverini tanlashni tuzatish](#fix-schema-connection-driver-selection)
- [Fix routes registered in ServiceProvider.Boot() silently discarded when WithMiddleware() is used](#fix-routes-registered-in-serviceprovider-boot-silently-discarded-when-withmiddleware-is-used)
- [Request InputArray bo'shliqlar bilan yagona qiymatlarni ajratishini tuzatish](#fix-request-inputarray-splitting-single-values-with-spaces)
- [Ko'p segmentli modul yo'llari uchun generator importlarini tuzatish](#fix-generator-imports-for-multi-segment-module-paths)
- [Fix LOG_LEVEL not being respected](#fix-log-level-not-being-respected)
...
Shunga muvofiq o‘zgartirish kerak: [gRPC konfiguratsiyasini o‘zgartirish](#grpc-konfiguratsiyasini-o-zgartirish)
...
Shunga muvofiq o‘zgartirish kerak: [Paket sozlash metodini o‘zgartirish](#paket-sozlash-metodini-o-zgartirish)

### 7. Agar siz machinery navbat haydovchisidan foydalanayotgan bo'lsangiz

Shunga mos ravishda o'zgartirish kerak: [machinery navbat haydovchisi olib tashlandi](#machinery-navbat-haydovchisi-olib-tashlandi)

### 8. Agar siz maxsus log haydovchisi yaratgan bo'lsangiz

Shunga mos ravishda o'zgartirish kerak: [Log haydovchisi almashtirildi](#log-drayverini-almashtirish)

### 9. Agar siz Http.Request.Bind funksiyasidan foydalanayotgan bo'lsangiz

Shunga mos ravishda o'zgartirish kerak: [Http.Request.Bind funksiyasi olib tashlandi](#http-request-bind-funksiyasini-olib-tashlash)

### 10. Agar siz validation.Make funksiyasi yoki maxsus qoidalar/filtrlardan foydalanayotgan bo'lsangiz

Shunga mos ravishda o'zgartirish kerak: [Validation kontekstni uzatishni qo'llab-quvvatlaydi](#validatsiya-kontekstni-uzatishni-qo-llab-quvvatlaydi)

### 11. Agar siz Orm-da global scopes-lardan foydalanayotgan bo'lsangiz

Shunga mos ravishda o'zgartirish kerak: [Orm uchun WithoutGlobalScopes funksiyasini qo'shish](#orm-uchun-withoutglobalscopes-funksiyasi-qo-shildi)
...
Bu xususiyat faqat [yangi soddalashtirilgan kod tuzilmasi](#soddalashtirilgan-kod-tuzilmasi) dan foydalanganda mavjud.
...
[Goravel Lite](#goravel-lite) ning chiqarilishi bilan birga, endi fasadlar `package:install` va `package:uninstall` buyruqlari orqali kerak bo'lganda o'rnatilishi va o'chirilishi mumkin. Eslatma: bu xususiyat faqat sizning loyihangiz Goravel Lite bilan qurilgan yoki [yangi soddalashtirilgan kod tuzilmasi](#soddalashtirilgan-kod-tuzilmasi) ga yangilangan bo'lsagina mavjud.
...
Ilgari, `package:install` buyrug‘i ishga tushirilganda, paket xizmat provayderi `setup.go` fayli orqali `config/app.go` ga o‘rnatilishi mumkin edi. Endi, [Soddalashtirilgan Kod Tuzilmasi](#soddalashtirilgan-kod-tuzilmasi) ishga tushirilganligi sababli, xizmat provayderi `bootstrap/providers.go` fayliga o‘rnatilishi qo‘llab-quvvatlanadi.
...
### Schema ulanish drayverini tanlashni tuzatish

goravel/framework: v1.17.3

Ilgari, `facades.Schema().Connection(name)` tanlangan ulanishdan foydalangan, ammo schema so'rovlarini hali ham standart ulanish drayveri bilan kompilyatsiya qilgan. Endi `HasTable` va `db:wipe --database` kabi sxema operatsiyalari tanlangan ulanishning drayveri, grammatikasi, protsessori, jadval prefiksi va sxema metama'lumotlaridan foydalanadi.

Muammo: [#942](https://github.com/goravel/goravel/issues/942)

### WithMiddleware() ishlatilganda ServiceProvider.Boot() da ro'yxatdan o'tgan marshrutlarning jimgina bekor qilinishi tuzatildi

goravel/framework: v1.17.3

Ilgari, global vositachilar `bootstrap/app.go` da `WithMiddleware()` orqali ro'yxatdan o'tkazilganda, `configureMiddleware()` `Boot()` dan keyin ishga tushirilgan, bu marshrut dvigatelini qayta qurgan va xizmat ko'rsatuvchi provayderlar tomonidan `Boot()` vaqtida ro'yxatdan o'tgan marshrutlarni bekor qilgan. Endi `configureMiddleware()` `Register()` va `Boot()` o'rtasida ishga tushiriladi, bu esa provayder tomonidan ro'yxatdan o'tgan marshrutlarning dvigatel qayta qurilishidan omon qolishini ta'minlaydi.

Muammo: [#975](https://github.com/goravel/goravel/issues/975)

### Request InputArray ning bitta qiymatlarni bo'shliqlar bilan ajratishi tuzatildi

goravel/gin: v1.17.1

goravel/fiber: v1.17.1

Ilgari, `ctx.Request().InputArray` bir shakl yoki urlencoded massiv qiymatini bo'sh joylarni o'z ichiga olgan bir nechta yozuvlarga ajratishi mumkin edi. Endi `123 456 789` kabi bitta topshirilgan qiymat bitta massiv elementi bo'lib qoladi, ko'p qiymatli massivlar esa o'z xatti-harakatlarini saqlab qoladi.

Muammo: [#961](https://github.com/goravel/goravel/issues/961)

### Multi-segment modul yo'llari uchun generator importlarini tuzatish

goravel/framework: v1.17.3

Ilgari, `make:migration`, `make:test` va paket iskala kabi generatorlar faqat multi-segment `go.mod` modul yo'lining oxirgi segmentidan foydalanib importlarni yaratishi mumkin edi. Endi yaratilgan importlar to'liq modul yo'lidan foydalanadi, masalan `github.com/example/project/app/facades`.

Muammo: [#973](https://github.com/goravel/goravel/issues/973)

### LOG_LEVEL ga rioya qilinmasligini tuzatish

goravel/framework: v1.17.3

Ilgari, `LOG_LEVEL=error` oʻrnatish hech qanday taʼsir koʻrsatmadi — axborot va disk raskadrovka xabarlari baribir yozilardi, chunki `Writer.log()` daraja tekshiruvini chetlab oʻtgan edi. Endi har qanday jurnal yozuvini yozishdan oldin sozlangan `LOG_LEVEL` toʻgʻri tekshiriladi.

Muammo: [#977](https://github.com/goravel/goravel/issues/977)

### Standart bo'lmagan ulanishdagi migratsiyalar jurnal yozuvini noto'g'ri ma'lumotlar bazasiga yozishini tuzatish

goravel/framework: v1.17.4
