...
- [Lokallashtirish](#mahalliylashtirish)
- [Oʻrnatuvchi](#o-rnatuvchi)
- [Cookie](#cookie)
- [Sessiya](#seans)

### Takomillashtirishlar 🚀

- [Gin va Fiber drayverlarida body_limit va header_limit ni sozlashni qoʻllab-quvvatlash](#gin-va-fiber-haydovchilarida-body-limit-va-header-limit-ni-o-rnatish-uchun-qo-llab-quvvatlash)
- [Log yangi metodlar qoʻshadi](#log-yangi-usullarni-qo-shadi)
- [Orm yangi metodlar qoʻshadi](#orm-yangi-usullarni-qo-shadi)
- [Console yangi metodlar qoʻshadi](#console-yangi-usullarni-qo-shadi)
- [Response yangi metodlar qoʻshadi](#response-yangi-usullarni-qo-shadi)
- [Build buyrugʻini qoʻshish](#build-buyrug-ini-qo-shish)
- [Yordamchi metodlarni qoʻshish](#yordamchi-usullarni-qo-shish)
- [Redis drayveri TLS ni qoʻllab-quvvatlaydi](#redis-haydovchisi-tls-ni-qo-llab-quvvatlaydi)

### Muhim Oʻzgarishlar 🛠

- [Tekshiruv muvaffaqiyatsiz boʻlsa, Validation maʼlumotlarni bogʻlamaydi](#tekshiruv-muvaffaqiyatsiz-bo-lsa-ma-lumotlarni-bog-lamaydi)
- [Testing moduli uchun yangi metodlar qoʻshish va metodlarni oʻzgartirish](#testing-moduli-uchun-yangi-usullarni-qo-shish-va-usullarni-o-zgartirish)
- [Mail modulining Queue metodini optimallashtirish](#mail-modulining-queue-usulini-optimallashtirish)
- [Auth moduli ctx ning sozlash metodini optimallashtirish](#auth-moduli-ctx-ning-sozlash-usulini-optimallashtirish)
- [Mock fasadlar usulini optimallashtirish](#mock-facades-usulini-optimallashtirish)
- [Framework Orm modeli json tegnini qoʻshadi](#framework-orm-modeli-json-tegini-qo-shadi)

### v1.14.1

- [Gin drayverida sessiya muvaffaqiyatli oʻrnatilmayotgan muammoni tuzatish](#gin-haydovchisida-sessiya-muvaffaqiyatli-o-rnatilmagan-muammosini-tuzatish)
- [Lokallashtirish modulida til faylini oʻqib boʻlmayotgan muammoni tuzatish](#lokalizatsiya-modulida-til-faylini-o-qib-bo-lmaydigan-muammosini-tuzatish)

### v1.14.2

- [Rasm va fayl tekshiruvi muvaffaqiyatsiz boʻlgan Validation tekshiruvini tuzatish](#tasdiqlash-validation-tasvir-va-fayl-tekshiruvi-muvaffaqiyatsiz-tugagan-muammosini-tuzatish)
- [goravel/gin drayveri tomonidan oʻrnatilgan cookie Expires ning yaroqsiz boʻlgan muammosini tuzatish](#goravel-gin-haydovchisi-tomonidan-o-rnatilgan-cookie-expires-yaroqsiz-bo-lgan-muammosini-tuzatish)

### v1.14.3

Tegishli paketlarni yangilash: goravel/gin: v1.2.2, goravel/fiber: v1.2.2

- [Validation slice ni bogʻlay olmayotgan muammoni tuzatish](#tasdiqlash-validation-kesim-slice-bog-lay-olmaydigan-muammosini-tuzatish)
- [Validation carbon ni bogʻlashni qoʻllab-quvvatlaydi](#tasdiqlash-validation-carbon-bog-lashni-qo-llab-quvvatlaydi)

### v1.14.4

Tegishli paketlarni yangilash: goravel/gin: v1.2.3

- [Sessiya konkurent muammosini tuzatish](#sessiya-konkurent-muammosini-tuzatish)
- [Gin Sessiya same_site ni yaroqsiz oʻrnatayotgan muammoni tuzatish](#gin-sessiya-same-site-parametrini-noto-g-ri-o-rnatgan-muammosini-tuzatish)

### v1.14.5

Tegishli paketlarni yangilash: goravel/gin: v1.2.4, goravel/fiber: v1.2.3

- [Route uchun Shutdown metodini qoʻshish](#route-uchun-shutdown-metodini-qo-shish)

### v1.14.7

Tegishli paketlarni yangilash: goravel/gin: v1.2.5, goravel/fiber: v1.2.4

- [HTTP ning ctx.WithValue metodini optimallashtirish](#http-ning-ctx-withvalue-metodini-optimallashtirish)

### v1.14.8

- [Tinglovchini roʻyxatdan oʻtkazishdagi ziddiyat muammosini tuzatish](#eshituvchini-ro-yxatdan-o-tkazish-ziddiyati-muammosini-tuzatish)

### v1.14.9

- [Maxsus Log drayveri console takroriy chop etish muammosini tuzatish](#maxsus-log-haydovchisi-konsolida-takroriy-chop-etish-muammosini-tuzatish)
- [HTTP JSON Soʻrovi koʻp darajali tuzilishni oʻz ichiga olganda maʼlumotlarni bogʻlash xatosi muammosini tuzatish](#http-json-so-rovi-ko-p-darajali-tuzilishni-o-z-ichiga-olganda-ma-lumotlarni-bog-lash-xatosi-muammosini-tuzatish)
...
Maʼlumotlar tekshiruvi muvaffaqiyatsiz boʻlsa ham, bogʻlangan qiymatni oʻqishga urinayotganingizni tasdiqlang. Agar shunday boʻlsa, mantiqni optimallashtirishingiz kerak, chunki yangilashdan keyin qiymat boʻsh boʻladi. Qarang: [Tekshiruv muvaffaqiyatsiz boʻlsa, Validation maʼlumotlarni bogʻlamaydi](#tekshiruv-muvaffaqiyatsiz-bo-lsa-ma-lumotlarni-bog-lamaydi).

### 4. Agar Testing moduli ishlatilsa

`Clear`, `Image` metodlaridan foydalanayotganingizni tekshiring, agar shunday boʻlsa, mos ravishda oʻzgartirishingiz kerak: [Testing moduli uchun yangi metodlar qoʻshish va metodlarni oʻzgartirish](#testing-moduli-uchun-yangi-usullarni-qo-shish-va-usullarni-o-zgartirish)

### 5. agar Mail moduli ishlatilsa

`Queue` metodidan foydalanayotganingizni tekshiring, agar shunday boʻlsa, mos ravishda oʻzgartirishingiz kerak: [Mail modulining Queue metodini optimallashtirish](#mail-modulining-queue-usulini-optimallashtirish)

### 6. Agar Auth moduli ishlatilsa

Mos ravishda oʻzgartirishingiz kerak: [Auth moduli ctx ning sozlash metodini optimallashtirish](#auth-moduli-ctx-ning-sozlash-usulini-optimallashtirish)

### 7. Agar mock fasadlar ishlatilsa

Mos ravishda oʻzgartirishingiz kerak: [Mock fasadlar usulini optimallashtirish](#mock-facades-usulini-optimallashtirish)

### 8. Agar framework Orm modeli ishlatilsa va maʼlumotlar toʻgʻridan-toʻgʻri endpoint orqali qaytarilsa

Mos ravishda oʻzgartirishingiz kerak: [Framework Orm modeli json tegnini qoʻshadi](#framework-orm-modeli-json-tegini-qo-shadi)
