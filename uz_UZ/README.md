...
[![Hujjat](https://pkg.go.dev/badge/github.com/goravel/framework)](https://pkg.go.dev/github.com/goravel/framework)
[![Go](https://img.shields.io/github/go-mod/go-version/goravel/framework)](https://go.dev/)
[![Reliz](https://img.shields.io/github/release/goravel/framework.svg)](https://github.com/goravel/framework/releases)
[![Test](https://github.com/goravel/framework/actions/workflows/test.yml/badge.svg)](https://github.com/goravel/framework/actions)
[![Hisobot kartasi](https://goreportcard.com/badge/github.com/goravel/framework)](https://goreportcard.com/report/github.com/goravel/framework)
[![Codecov](https://codecov.io/gh/goravel/framework/branch/master/graph/badge.svg)](https://codecov.io/gh/goravel/framework)
![Litsenziya](https://img.shields.io/github/license/goravel/framework)
...
| Modul nomi                                                                                      | Tavsifi                                                                                 |
| ----------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [Artisan Console](https://www.goravel.dev/uz_UZ/digging-deeper/artisan-console.html)            | Ilova boshqaruvi va avtomatlashtirish uchun CLI buyruq qatori interfeysi                |
| [Authentication](https://www.goravel.dev/uz_UZ/security/authentication.html)                    | Foydalanuvchi identifikatsiyasini JWT va Session haydovchilari bilan tekshirish         |
| [Authorization](https://www.goravel.dev/uz_UZ/security/authorization.html)                      | Siyosat va darvozalar yordamida ruxsat asosidagi kirish nazorati                        |
| [Cache](https://www.goravel.dev/uz_UZ/digging-deeper/cache.html)                                | Ma'lumotlarni xotira, Redis yoki maxsus drayverlar yordamida saqlang va oling           |
| [Carbon](https://www.goravel.dev/uz_UZ/digging-deeper/helpers.html)                             | Sana va vaqt manipulyatsiyasi uchun yordamchi funksiyalar                               |
| [Konfiguratsiya](https://www.goravel.dev/uz_UZ/getting-started/configuration.html)              | Fayllar va muhitdan ilova konfiguratsiyasini boshqarish                                 |
| [Kriptlash](https://www.goravel.dev/uz_UZ/security/encryption.html)                             | Xavfsiz ma'lumotlarni shifrlash va shifrdan ochish vositalari                           |
| [MB](https://www.goravel.dev/uz_UZ/database/getting-started.html)                               | Ma'lumotlar bazasi so'rov quruvchisi                                                    |
| [Hodisa](https://www.goravel.dev/uz_UZ/digging-deeper/event.html)                               | Ilova hodisalarini tarqatish va tinglash tizimi                                         |
| [Fabrika](https://www.goravel.dev/uz_UZ/orm/factories.html)                                     | Test maqsadlari uchun soxta model ma'lumotlarini yaratish                               |
| [FileStorage](https://www.goravel.dev/uz_UZ/digging-deeper/filesystem.html)                     | Fayl yuklash, yuklab olish va bir nechta haydovchilar orqali saqlash                    |
| [Grpc](https://www.goravel.dev/uz_UZ/the-basics/grpc.html)                                      | Yuqori samaradorlikdagi gRPC server va mijoz amalga oshirilishi                         |
| [Hash](https://www.goravel.dev/uz_UZ/security/hashing.html)                                     | Xavfsiz parol xeshlash                                                                  |
| [Http](https://www.goravel.dev/uz_UZ/the-basics/routing.html)                                   | HTTP marshrutlash, kontrollerlar va middleware boshqaruv                                |
| [Http Client](https://www.goravel.dev/uz_UZ/digging-deeper/http-client.html)                    | Tashqi API va xizmatlarga HTTP so‘rovlarni amalga oshiring                              |
| [Lokalizatsiya](https://www.goravel.dev/uz_UZ/digging-deeper/localization.html)                 | Ko'p tilli tarjima va til sozlamalarini boshqarish                                      |
| [Logger](https://www.goravel.dev/uz_UZ/the-basics/logging.html)                                 | Ilovalarni fayllarga, konsolga yoki tashqi xizmatlarga yozish                           |
| [Pochta](https://www.goravel.dev/uz_UZ/digging-deeper/mail.html)                                | SMTP or navbatga asoslangan yetkazib berish orqali elektron pochta xabarlarini yuboring |
| [Mock](https://www.goravel.dev/uz_UZ/testing/mock.html)                                         | Fasadlar va qaramliklar uchun sinov namunalarini yarating                               |
| [Migrate](https://www.goravel.dev/uz_UZ/database/migrations.html)                               | Ma'lumotlar bazasi sxemasi o'zgarishlari uchun versiyalarni boshqarish                  |
| [Orm](https://www.goravel.dev/uz_UZ/orm/getting-started.html)                                   | Ma'lumotlar bazasi operatsiyalari uchun nafis Orm amalga oshirilishi                    |
| [Paketni Ishlab Chiqish](https://www.goravel.dev/uz_UZ/digging-deeper/package-development.html) | Freymvork funksiyalarini kengaytirish uchun qayta ishlatiladigan paketlar yarating      |
| [Jarayon](https://www.goravel.dev/uz_UZ/digging-deeper/process.html)                            | Go standart `os/exec` paketi atrofida ifodali va nafis API                              |
| [Navbat](https://www.goravel.dev/uz_UZ/digging-deeper/queues.html)                              | Vaqt talab qiladigan vazifalarni orqa fondagi ish jarayoniga topshirish                 |
| [Seeder](https://www.goravel.dev/uz_UZ/database/seeding.html)                                   | Ma'lumotlar bazasi jadvallarini sinov yoki boshlang'ich ma'lumotlar bilan to'ldiring    |
| [Sessiya](https://www.goravel.dev/uz_UZ/the-basics/session.html)                                | HTTP so'rovlari bo'ylab foydalanuvchi sessiyasi ma'lumotlarini boshqarish               |
| [Vazifa rejalashtirish](https://www.goravel.dev/uz_UZ/digging-deeper/task-scheduling.html)      | Cron-ga o'xshash ifodalar yordamida takrorlanuvchi vazifalarni rejalashtiring           |
| [Testlash](https://www.goravel.dev/uz_UZ/testing/getting-started.html)                          | HTTP testlash, mocklash va tasdiqlash vositalari                                        |
| [Tekshirish](https://www.goravel.dev/uz_UZ/the-basics/validation.html)                          | Qoidalardan foydalanib kiruvchi so'rov ma'lumotlarini tekshirish                        |
| [Koʻrish](https://www.goravel.dev/uz_UZ/the-basics/views.html)                                  | HTML javoblar uchun shablonlarni ko'rsatish dvigateli                                   |

## Laravel bilan solishtiring

[Batafsil ma'lumot uchun](https://www.goravel.dev/uz_UZ/prologue/compare-with-laravel.html)
...
[Tafsilotlar uchun](https://www.goravel.dev/uz_UZ/getting-started/packages.html)
